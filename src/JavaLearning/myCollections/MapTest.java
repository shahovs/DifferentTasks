...
public class MapTest {
    ...
    public static void main(String[] args) {
        ...
        // Проверяю, что из мапы удалилась пара ключ-значение (одна из двух пар с подходящим value)
        ...
        // Удаление пары из мапы не удаляет объекты (ведь в Java мы вообще никогда не можем удалять объекты),
